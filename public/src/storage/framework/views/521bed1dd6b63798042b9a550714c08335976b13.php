<script data-exec-on-popstate>
    ...
    $(function () {
        ...
        $('.api-tester-form').on('submit', function (event) {
            ...
            $.ajax({
                method: 'POST',
                url: '<?php echo e(route('api-tester-handle')); ?>',
                data: formData,
                async: false,
            ...
            <div class="tab-content">
                ...
                <ul class="nav nav-pills nav-stacked routes" style="margin-top: 5px;">
                    <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="route-item"
                            data-uri="<?php echo e($route['uri']); ?>"
                            data-method="<?php echo e($route['method']); ?>"
                            data-method-color="<?php echo e($color); ?>"
                            data-parameters='<?php echo $route['parameters']; ?>' >

                            <a href="#"><b><?php echo e($route['uri']); ?></b>
                                <div class="pull-right">
                                    <span class="label bg-<?php echo e($color); ?>"><?php echo e($route['method']); ?></span>
                                </div>
                            </a>
                        </li>
